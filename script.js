...
for (let i = 0; i < users.length; i++) {
  let _element = document.getElementById(`section${i + 1}`);
  _element.children[0].children[0].style.background = `url(${users[i].imgUrl}) center/100%`;
  _element.children[0].children[1].children[0].innerHTML = users[i].name;
  _element.children[0].children[1].children[1].innerHTML = users[i].title;
  _element.children[1].children[0].innerHTML = users[i].mainQuote;
  _element.children[2].children[0].innerHTML = users[i].fullQuote;
}
